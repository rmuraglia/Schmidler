...
# load QL algorithms
source('ql_algorithm_fullhist.r')
...
pcolors<-c('black', 'black', 'black', rich.colors(num_solns-3))
...
outplot<-arrangeGrob(p0, p4, p5, p6, p7, nrow=2, widths=c(1,1,1))

ggsave(file='maze-grid02-monitor-05.png', width=9, height=6, dpi=100, plot=outplot)
ggsave(file='maze-grid01-monitor-05.png', width=9, height=9, dpi=100, plot=outplot)
ggsave(file='maze-grid02-monitor-04.png', width=7, height=6, dpi=100, plot=outplot)
